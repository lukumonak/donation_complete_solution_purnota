...
function OrgAccess() {
  ...
  const baseUrl = 'https://donation-complete-solution-purnota-3.onrender.com/api/oldThs/all';
  ...
  const buttonClick =  async (email) => {
    ...
    axios.post('https://donation-complete-solution-purnota-3.onrender.com/api/organization/sndMail', {email})
